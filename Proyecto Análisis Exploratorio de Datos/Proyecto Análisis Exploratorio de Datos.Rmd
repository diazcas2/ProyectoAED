...
ggplot(as.data.frame(table(sapply((df2$fecha),weekdays))/2656), aes(x = Var1, y = Freq, fill = Var1),options(repr.plot.width = 9, repr.plot.height =4)) +geom_col(color='blue',fill = "lavender")+ labs(title = "Número de registros por día de la semana",  x = "Día de la semana", y = "Frecuencia") + theme_minimal()
```
